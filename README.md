...
|Projektpartnerunternehmen (Auftraggeber)|LucaNet AG|
|Betreuer beim Projektpartner|Richard Petrauskas, Michael Brecht|
|Projektteam|Per Ejsmont, Corvin Schwarzer|
|Zugehörige Lieferobjekte|4-7|
...
Dabei ist symetrische Verschlüsselung standardmäßig einzusetzen. Die Login-Daten werden als Variablen gespeichert.